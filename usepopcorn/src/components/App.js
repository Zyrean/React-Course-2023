...
function Box({ handleIsOpen, children }) {
...
function MovieDetails({ selectedId, onCloseMovie, onAddWatched, watched }) {
  ...
  function handleAdd() {
    ...
    // onAddWatched((selectedId) =>
    //   selectedId === newWatchedMovie.imdbID
    //     ? console.log("TEST1")
    //     : console.log("TEST2")
    // );
          ...
          <section>
            <div className="rating">
              {!isWatched ? (
                ...
                <p>YOUR RATED THAT MOVIE {watchedUserRating}&#11088; !</p>
              )}
            </div>
